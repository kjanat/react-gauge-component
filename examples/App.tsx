        ...
        <div className="props-grid">
          <div>
            ...
            <ul>
              ...
              <li><code>max</code> - Maximum value (default: 5)</li>
              <li><code>label</code> - Text label below gauge</li>
              <li><code>size</code> - Width in pixels (default: 300)</li>
              <li><code>thickness</code> - Arc thickness (default: 40)</li>
            </ul>
          </div>
          <div>
            <h3>Display Options:</h3>
            <ul>
              <li><code>displayType</code> - 'percentage', 'value', or 'custom'</li>
              <li><code>customDisplay</code> - Function to format display</li>
              <li><code>tickInterval</code> - Interval between ticks (default: 1)</li>
              <li><code>showTicks</code> - Show tick marks (default: true)</li>
              <li><code>colors</code> - Array of segment colors</li>
            </ul>
          </div>
        </div>
